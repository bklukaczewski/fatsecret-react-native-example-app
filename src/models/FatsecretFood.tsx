...
/*
  It would be recommended to convert Fatsecret response types to our own (with camelCase property names and
...
export interface FatsecretFood {
  ...
  servings?: {
    /* Serving from API can be either a list or plain object. */
